...
{
    self.destination = [[MAPointAnnotation alloc] init];//Annotation   n. 注解,注释
    
    self.destination.coordinate = CLLocationCoordinate2DMake(39.923034, 116.388988);//coordinate  n.坐标
